...
\todo{Say something about why the account-controller hasn't been tested? Bip-bop.}
The main part of the DriveIT Web API consists of the public controllers which handles the requests from users. As mentioned earlier, one important thing to remember when testing is to test the implemented logic, and not the framework surrounding it. Therefore we have tested the Web API using mocks as the repository, and by calling the methods directly instead of using HTTP-requests.
